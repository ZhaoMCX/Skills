...
- Subagent Delegation Strategy either defines safe independent tasks with non-overlapping write scope and verification, or states `No delegation` with a concrete reason.
