...
- Use the general `dispatch-agents` skill during execution when delegation is chosen.
...
- Each delegated task must have one owner, allowed files/modules, forbidden files/modules, expected output, and verification Gate.
