...
- Delegation must follow `af-dispatch-agents`: independent AF-scoped tasks, non-overlapping write scope, no unresolved shared decisions, clear verification, concrete AF coordinates, and main-agent integration responsibility.
